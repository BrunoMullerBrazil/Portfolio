...
export const BLOCKS: Block[] = [
  ...
  { type: "quote", text: "O jogo durou pouco. O que ficou foi o programa." },
  {
    type: "body",
  ...
  { type: "chapter", label: "Técnico e quartel" },
  {
    type: "body",
  ...
  { type: "chapter", label: "Volta pra Floripa" },
  {
    type: "body",
  ...
  { type: "quote", text: "Não tinha reserva, não tinha cliente e não tinha plano B." },
  {
    type: "body",
  ...
  { type: "chapter", label: "Retenção Day" },
  {
    type: "body",
    text: "A resposta apareceu no Retenção Day. Agendamento, lead e call center sentados juntos, telefone o dia inteiro, brinde empilhado na mesa e uma energia que eu nunca tinha visto naquele prédio. Cinco mil ligações. Quatrocentas retenções a mais. Eu produzi o filme daquilo, e ele funcionou de um jeito que os bonitos nunca funcionaram. Não tinha luz, não tinha trilha épica, não tinha nada que eu pudesse pendurar num reel. Tinha gente trabalhando.",
  },
  {
    type: "stats",
    items: [
  ...
  {
    type: "body",
    text: "Duas empresas, dois mundos que não se falam, e a mesma cena nos dois. A empresa é boa. O produto aguenta comparação. O cliente volta. E o material público poderia ter o logo trocado sem ninguém notar.",
  },
  { type: "quote", text: "E o material público poderia ter o logo trocado sem ninguém notar." },
  {
    type: "body",
    text: "Não é falta de produção. Elas produzem muito. É que ninguém para pra perguntar o que aquilo está dizendo antes de mandar fazer mais.",
  },
  {
    type: "body",
    text: "Reparo nisso porque nunca fui o fornecedor de fora. Sempre fui quem recebe o vídeo pronto, aprova o orçamento e responde depois quando não dá certo. Isso estraga você pra sempre. Não consigo mais assistir a um filme institucional sem imaginar a reunião que o produziu.",
  },
  {
    type: "quote",
    text: "Isso estraga você pra sempre. Não consigo mais assistir a um filme institucional sem imaginar a reunião que o produziu.",
  },
];
